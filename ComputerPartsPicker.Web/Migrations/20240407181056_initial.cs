...
namespace ComputerPartsPicker.Web.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_Orders_OrderUserId_OrderProductId",
                        columns: x => new { x.OrderUserId, x.OrderProductId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_OrderUserId_OrderProductId",
                table: "Products",
                columns: new[] { "OrderUserId", "OrderProductId" });
